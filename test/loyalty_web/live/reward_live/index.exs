defmodule LoyaltyWeb.RewardLive.IndexTest do
  ...
  describe "Index" do
    ...
    test "lists all rewards for a loyalty program", %{conn: conn, loyalty_program: loyalty_program} do
    ...
    test "displays action buttons for each reward", %{conn: conn, loyalty_program: loyalty_program} do
    ...
    test "navigates back to loyalty programs when back link is clicked", %{conn: conn, loyalty_program: loyalty_program} do
  ...
  describe "New Modal" do
    ...
    test "opens new modal when Add button is clicked", %{conn: conn, loyalty_program: loyalty_program} do
      {:ok, index_live, _html} = live(conn, ~p"/loyalty_programs/#{loyalty_program.id}/rewards")
    ...
    test "displays validation errors for invalid data", %{conn: conn, loyalty_program: loyalty_program} do
      {:ok, index_live, _html} = live(conn, ~p"/loyalty_programs/#{loyalty_program.id}/rewards")
  ...
  describe "Edit Modal" do
    ...
    test "opens edit modal when Edit button is clicked", %{conn: conn, loyalty_program: loyalty_program, reward: reward} do
      {:ok, index_live, _html} = live(conn, ~p"/loyalty_programs/#{loyalty_program.id}/rewards")
    ...
    test "updates reward with valid data", %{conn: conn, loyalty_program: loyalty_program, reward: reward} do
      {:ok, index_live, _html} = live(conn, ~p"/loyalty_programs/#{loyalty_program.id}/rewards")
    ...
    test "displays validation errors when updating with invalid data", %{conn: conn, loyalty_program: loyalty_program, reward: reward} do
      {:ok, index_live, _html} = live(conn, ~p"/loyalty_programs/#{loyalty_program.id}/rewards")
  ...
  describe "Delete Confirmation" do
    ...
    test "shows delete confirmation dialog", %{conn: conn, loyalty_program: loyalty_program, reward: reward} do
      {:ok, index_live, _html} = live(conn, ~p"/loyalty_programs/#{loyalty_program.id}/rewards")
    ...
    test "cancels delete when No is clicked", %{conn: conn, loyalty_program: loyalty_program, reward: reward} do
      {:ok, index_live, _html} = live(conn, ~p"/loyalty_programs/#{loyalty_program.id}/rewards")
    ...
    test "deletes reward when Yes is clicked", %{conn: conn, loyalty_program: loyalty_program, reward: reward} do
      {:ok, index_live, _html} = live(conn, ~p"/loyalty_programs/#{loyalty_program.id}/rewards")
  ...
  describe "Multiple Rewards" do
    ...
    test "displays multiple rewards for the same program", %{conn: conn, loyalty_program: loyalty_program} do
    ...
    test "only displays rewards for the current loyalty program", %{conn: conn, loyalty_program: loyalty_program} do
